  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        {/* Status bar */}
        <div className="mt-8 pt-4 border-t border-border flex items-center justify-center gap-1.5 text-xs text-muted-foreground font-mono">
          <span className="w-1.5 h-1.5 rounded-full bg-cyan pulse-dot" />
          Jarvis Home Assist · Local Network
        </div>
      </motion.div>
    </div>
  );
