...
export function useSidebar() {
  const { state, isOpen, setOpen, isMobile, setOpenMobile, toggleSidebar } =
    useSidebarStore();
  return {
    state,
    open: isOpen,
    setOpen,
    isMobile,
    openMobile: isOpen, // in mobile, isOpen maps to openMobile logic usually
    setOpenMobile,
    toggleSidebar,
  };
}
